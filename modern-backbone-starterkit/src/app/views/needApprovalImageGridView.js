...
import template from 'TEMPLATESDIR/needApprovalImageGridTemplate.hbs';
...
export default Backbone.View.extend({
  ...
  render: _.throttle(function() {
      const newHTMLString = template({
        images: this.articleCollection.toJSON(), // TODO clean up later. This is actually an image collection not an article collection.
